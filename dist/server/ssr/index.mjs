...
var client_references_default = {
	"f29e6e234fea": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-o9SwANkj.mjs")).export_f29e6e234fea;
	},
	"0deffcb8ffd7": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-o9SwANkj.mjs")).export_0deffcb8ffd7;
	},
	"ce76877553ca": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-o9SwANkj.mjs")).export_ce76877553ca;
	},
	"927fe43b75aa": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-o9SwANkj.mjs")).export_927fe43b75aa;
	},
	"1b003c57753d": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-o9SwANkj.mjs")).export_1b003c57753d;
	},
	"b1a19a4e637b": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-o9SwANkj.mjs")).export_b1a19a4e637b;
	},
	"73d7a23e5015": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-o9SwANkj.mjs")).export_73d7a23e5015;
	},
	"02ca88934bb2": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-o9SwANkj.mjs")).export_02ca88934bb2;
	},
	"5a4d3fe72cb3": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-o9SwANkj.mjs")).export_5a4d3fe72cb3;
	},
	"da1952991006": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-o9SwANkj.mjs")).export_da1952991006;
	},
	"36132fdd4942": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-o9SwANkj.mjs")).export_36132fdd4942;
	},
	"c8312bba060b": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-o9SwANkj.mjs")).export_c8312bba060b;
	}
};
//#endregion
...
//#endregion
export { __toESM as _, usePathname as a, toBrowserNavigationHref as c, stripBasePath as d, app_ssr_entry_default as default, __commonJSMin as f, __toCommonJS as g, __require as h, handleSsr, toRscUrl as i, toSameOriginAppPath as l, __exportAll as m, getPrefetchedUrls as n, useRouter as o, __esmMin as p, storePrefetchResponse as r, resolveRelativeHref as s, getLayoutSegmentContext as t, withBasePath as u };
