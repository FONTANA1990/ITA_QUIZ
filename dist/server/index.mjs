...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "4743f662-53f6-47d1-9219-6cba787d6bec";
	}
};
...
//#endregion
//#region \0virtual:vinext-google-fonts?fonts=Outfit
var Outfit = /* @__PURE__ */ createFontLoader("Outfit");
//#endregion
//#region src/components/BottomNav.tsx
var BottomNav_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "da1952991006", "default");
//#endregion
//#region src/components/PageLayoutWrapper.tsx
var PageLayoutWrapper_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "36132fdd4942", "default");
//#endregion
//#region src/context/UserContext.tsx
var UserProvider = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'UserProvider' is called on server");
}, "c8312bba060b", "UserProvider");
//#endregion
...
var outfit = Outfit({ subsets: ["latin"] });
var metadata = {
	title: "ITA QUIZ",
...
function RootLayout({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("html", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("body", {
			className: `${outfit.className} bg-slate-950 text-slate-50 antialiased overflow-x-hidden min-h-screen flex flex-col`,
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(UserProvider, { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(PageLayoutWrapper_default, { children }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(BottomNav_default, {})] })
		})
	});
}
...
function __isrCacheKey(pathname, suffix) {
	...
	const prefix = "app:4743f662-53f6-47d1-9219-6cba787d6bec";
...
var routes = [
	...
	{
		pattern: "/history",
		patternParts: ["history"],
		isDynamic: false,
		params: [],
		page: page_exports$4,
		routeHandler: null,
		layouts: [layout_exports],
		routeSegments: ["history"],
		layoutTreePositions: [0],
		templates: [],
		errors: [null],
		slots: {},
	...
	{
		pattern: "/leaderboard",
		patternParts: ["leaderboard"],
		isDynamic: false,
		params: [],
		page: page_exports$3,
		routeHandler: null,
		layouts: [layout_exports],
		routeSegments: ["leaderboard"],
		layoutTreePositions: [0],
		templates: [],
		errors: [null],
		slots: {},
	...
	{
		pattern: "/admin/:id",
		patternParts: ["admin", ":id"],
		isDynamic: true,
		params: ["id"],
		page: page_exports$1,
		routeHandler: null,
		layouts: [layout_exports],
		routeSegments: ["admin", "[id]"],
		layoutTreePositions: [0],
		templates: [],
		errors: [null],
		slots: {},
	...
	{
		pattern: "/play/:id",
		patternParts: ["play", ":id"],
		isDynamic: true,
		params: ["id"],
		page: page_exports,
		routeHandler: null,
		layouts: [layout_exports],
		routeSegments: ["play", "[id]"],
		layoutTreePositions: [0],
		templates: [],
		errors: [null],
		slots: {},
